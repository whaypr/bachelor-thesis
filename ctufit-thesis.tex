...
\ctufitabstractENG{
    ...
    where $b$ denotes the number of edges allowed to be added into a given network,
    $d$ denotes the number of followers needed to have centrality at least as high as any of the leaders
...
\begin{acknowledgmentpage}
    ...
    they always strengthen my motivation to keep working and I always left them a little smarter,
