...
\ctufitabstractENG{
    ...
    We analyze results on this topic provided in the literature and survey them from the
    new perspective of the parameterized complexity.
    We also point out there are multiple definitions of the problem
    ...
    the problem is \Wh when parameterized by $b+d$ even when $|L|=1$, and \pNPh when parameterized by $|L|$,
    ...
    providing an easily accessible summary of the current state of the research of optimally solving \HL
    given the degree centrality and the four aforementioned parameters.
}
\ctufitabstractCZE{
...
\include{text/literature-review.tex}
