...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\includeonly{text/introduction.tex,text/preliminaries.tex,text/problem_statement.tex,text/contribution.tex}
...
\ctufitabstractENG{\todo{Fill in abstract of this thesis in English language}}
\ctufitabstractCZE{\todo{Fill in abstract of this thesis in Czech language}}
\ctufitkeywordsENG{Hiding Leaders problem, parameterized complexity, covert networks, centrality}
\ctufitkeywordsCZE{problém Hiding Leaders, parametrizovaná složitost, covert networks, centralita}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% END FILL IN
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
