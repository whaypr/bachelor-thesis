...
\begin{figure}[t]
    \centering
    \begin{tikzpicture}[node distance=16mm, every node/.style={scale=1.8}]
        ...
        \node[corollary,FPT,label={0:\small{\tt C\ref{cor:Ld:variation:FPT}}}] (LnLd) [right =of LnD] {\leadnum, \leaddeg};
        \node[corollary,Wh,label={0:\small{\tt C\ref{cor:LnBD:variation:Wh}}}] (BD) [right=of LnLd] {\budget, \safetymarg};
        \node[corollary,FPT,label={0:\small{\tt C\ref{cor:Ld:variation:FPT}}}] (BLd) [right=of BD] {\budget, \leaddeg};
        \node[corollary,FPT,label={0:\small{\tt C\ref{cor:Ld:variation:FPT}}}] (DLd) [right=of BLd] {\safetymarg, \leaddeg};
        % singletons
        \node[corollary,pNPh,label={0:\small{\tt C\ref{cor:Ln:pNPh}}}] (Ln) [above=of LnD] {\leadnum};
        \node[result,Wh,label={0:\small{\tt T\ref{theorem:B:XP}}}] (B) [right=of Ln] {\budget};
        \node[result,Wh,label={0:\small{\tt T\ref{theorem:D:XP}}}] (D) [right=of B] {\safetymarg};
        \node[FPT,label={0:\small{\tt B\cite{Dey2019}}}] (Ld) [right=of D] {\leaddeg};
        % triplets
        \node[result,Wh,label={0:\small{\tt T\ref{theorem:DB}}}] (LnBD) [below=of LnD] {\leadnum, \budget, \safetymarg};
        \node[corollary,FPT,label={0:\small{\tt C\ref{cor:Ld:variation:FPT}}}] (LnBLd) [right=of LnBD] {\leadnum, \budget, \leaddeg};
        \node[corollary,FPT,label={0:\small{\tt C\ref{cor:Ld:variation:FPT}}}] (LnDLd) [right=of LnBLd] {\leadnum, \safetymarg, \leaddeg};
        \node[corollary,FPT,label={0:\small{\tt C\ref{cor:Ld:variation:FPT}}}] (BDLd) [right=of LnDLd] {\budget, \safetymarg, \leaddeg};
        %quad
        \node[corollary,FPT,label={0:\small{\tt C\ref{cor:Ld:variation:FPT}}}] (LnBDLd) [below=of LnBLd] {\leadnum, \budget, \safetymarg, \leaddeg};
        % edges
        ...
        \draw[->,edgeFPT] (Ld.225) -- (LnLd.135);
        \draw[->,edgeFPT] (Ld.225) -- (BLd.135);
        \draw[->,edgeFPT] (Ld.225) -- (DLd.135);
        \draw[->,edgeFPT] (LnLd.225) -- (LnBLd.135);
        \draw[->,edgeFPT] (LnLd.225) -- (LnDLd.135);
        \draw[->,edgeFPT] (LnLd.225) -- (BDLd.135);
        \draw[->,edgeFPT] (LnBLd.225) -- (LnBDLd.135);
    \end{tikzpicture}
    \caption{
