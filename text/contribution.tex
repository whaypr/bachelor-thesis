...
\begin{proof}
    ...
    Because we take all the possible $b$-element subsets of $\hat{A}$, we eventually find a subset $B$ such that $B = W$,
    of course only if $(\mathcal{I}, b)$ is a $yes$-instance and thus such $W$ exists.
