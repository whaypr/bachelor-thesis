...
\begin{figure}[t]
    ...
    [Overviewing graph with results for \HLdeg]
    {
        ...
        Combinations of parameters that give rise to XP algorithms are highlighted in green,
        ...
        Orange arrows represent \XP class and violet arrows represent \W-hardness.
