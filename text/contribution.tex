...
\begin{proof}\label{proofDB}
    ...
    and since $\deg(l) = 0$ (before step 4), there are enough vertices for $\ell$ to connect with.
    ...
    For this reason, the fact that $H[F']$ is a complete graph means that there is a $k$-clique in $G$.
