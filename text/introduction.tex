...
intends is not the only possible, since the usefulness of Covert network analysis lingers even in handling situations
such as analyzing activist groups \cite{Crossley2012}.
CNA tools, as an extention of SNA, can be then used even for analyzing sports teams \cite{Buldú2019}.
